...
export function startSim() {
  const positions = [mkPosition('mean_reversion_bb', 'NVDA'), mkPosition('riley_signature', 'SPY'), mkOptionPosition('riley_signature', 'AAPL', 'swing')];
  simHydrate({
    engine: { state: 'RUNNING', state_reason: null, risk_config: { liveTradingEnabled: false, maxPerTradeUsd: 100, maxDailyLossUsd: 300, maxOpenPositions: 5, maxNotionalPerTradeUsd: 2000, maxExposurePct: 40, pdtProtection: true, cooldownLosses: 3, cooldownMinutes: 90, econBlackoutMinutes: 15 }, trading_account_id: 'SIM-ALPACA-PAPER' },
